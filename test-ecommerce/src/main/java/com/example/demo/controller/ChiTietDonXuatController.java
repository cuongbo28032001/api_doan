...
import com.example.demo.service.ChiTietDonXuatService;
...
public class ChiTietDonXuatController {
	...
	@PostMapping("/create")
	public ResponseEntity<?> create(@RequestBody List<ChiTietDonXuatRequest> chiTietDonXuats) {
		ResponseObj resp = this.chiTietDonXuatService.create(chiTietDonXuats);
